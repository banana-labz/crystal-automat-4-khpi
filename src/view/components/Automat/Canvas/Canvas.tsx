...
export const Canvas = ({ iteration, cells, cellSize }: CanvasProps) => {  
    ...
    return <CanvasStyled ref={canvasRef} width={canvasSize} height={canvasSize} />
}