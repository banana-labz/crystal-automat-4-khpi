...
import { AutomatStatusContainer, IterationIndicator, AutomatStatusButtons } from "./AutomatStatus.styled"
...
export const AutomatStatus = ({ iteration, pause, switchPause, resetAutomat }: AutomatStatusProps) => (
